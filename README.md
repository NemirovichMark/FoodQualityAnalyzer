...
Приложение для анализа качества продуктов питания с визуализацией данных в виде диаграммы и возможностью управления
списком продуктов.
...
- Дополнительные параметры (меняются в зависимости от типа продукта) - позволяют выбрать какие характеристики будут
  присвоены сохраняемому продукту
...
- Выпадающий список для выбора формата отчета (JSON/XML) - позволяет пользователю самостоятельно определить в каком
  формате сохранять отчет об анализе выбранных продуктов
